...
import com.assignment.loginfirebase.databinding.ActivityQuizBioBinding
import com.google.firebase.auth.FirebaseAuth

class QuizBio : AppCompatActivity() {

    var finalScore = 0
    private lateinit var binding: ActivityQuizBioBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizBioBinding.inflate(layoutInflater)
