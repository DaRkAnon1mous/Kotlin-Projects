...
import com.assignment.loginfirebase.databinding.ActivityQuizGkBinding
import com.google.firebase.auth.FirebaseAuth

class QuizGK : AppCompatActivity() {
    var finalScore = 0
    private lateinit var binding: ActivityQuizGkBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizGkBinding.inflate(layoutInflater)
