...
import com.assignment.loginfirebase.databinding.ActivityQuizCosmoBinding
import com.google.firebase.auth.FirebaseAuth

class QuizCosmo : AppCompatActivity() {

    var finalScore = 0
    private lateinit var binding: ActivityQuizCosmoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuizCosmoBinding.inflate(layoutInflater)
